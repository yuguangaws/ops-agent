...
#     try:
#         # ===================== 核心：流式遍历LangGraph节点 =====================
#         for step_event in workflow.stream(init_state):
#             # step_event 是字典，key是节点名，value是该节点更新后的状态
#             for node_name, node_state in step_event.items():
#                 # 更新审计日志
#                 new_logs = node_state.get("audit_logs", [])
#                 # 只追加新增的日志
#                 for log in new_logs[len(audit_logs):]:
#                     audit_logs.append(log)
#                     with status_container:
#                         st.write(f"✅ {log}")

#                 # 更新状态标签
#                 stage = node_state.get("process_stage", "排查中")
